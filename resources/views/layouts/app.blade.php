...
<body>
    <div id="app">
                ...
                <div class="w-full flex-grow lg:flex  lg:content-center lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 z-20" id="nav-content">
                    ...
                    <ul class="list-reset lg:flex justify-end items-center">
                        <li class="mr-3 py-2 lg:py-0">
                            <a class="inline-block py-2 px-4 text-gray-900 font-bold no-underline" href="/">Main page</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container w-full flex flex-wrap mx-auto px-2 pt-8 lg:pt-16 mt-16">
                    ...
                    <ul class="list-reset">
                        ...
                        <li class="py-2 md:my-0 hover:bg-purple-100 lg:hover:bg-transparent">
                            <a href="#" class="block pl-4 align-middle text-gray-700 no-underline hover:text-purple-500 border-l-4 border-transparent lg:hover:border-gray-400">
                                <span class="pb-1 md:pb-0 text-sm">Inactive link</span>
                            </a>
                        </li>
            ...
            <div class="w-full lg:w-4/5 p-5 mt-2 lg:mt-0 text-gray-900 leading-normal bg-white border border-gray-400 border-rounded">
                <!--Title-->
                <div class="font-sans">
                       <a href="#" class="text-base md:text-sm text-purple-500 font-bold no-underline hover:underline hidden">Back Link</a>
                       <h1 class="font-sans break-normal text-gray-900 pt-6 pb-2 text-xl hidden">Help page title</h1>
               <hr class="border-b border-gray-400 hidden">
                </div>
                @yield('content')
        </div>
        </div>
